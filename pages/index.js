    ...
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        <p>[My name is SK, and I am a software and web developer with
           a degree in Computer Science. Currently I am looking for a 
           Entry level Front-End Developer or Web Content Devloper position.]</p>
        <p>
          (This is an demo website - you can also follow the step-by-step instructions from this tutorials and learn more about Next.js{' '}
